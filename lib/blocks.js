 ...
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * Sconl's split, given 4 Aug and completed to all 24 hours on 5 Aug:
 *
 ...
 * puts "Agree the drafting split with Fred" in the creative block he will stop
...
module.exports = { init, blocks, allBlocks, now, classify, plan, save, TASK_MINUTES };

...
/**
 * Call ElevenLabs TTS. Returns a Buffer of MP3 audio.
 */
async function synthesize(scriptText, apiKey, { voiceId = VOICE_ID, modelId = MODEL_ID } = {}) {
...
module.exports = { VOICE_ID, VOICE_NAME, MODEL_ID, contentHash, mdToScript, synthesize };

...
const SCHEMA_EXCLUDE_FROM_SYNC = [
  ...
  // Same as above: new local-only ElevenLabs audio version registry
  // (2026-08-17). Created on upload by the narration engine; will exist on
  // OneDrive only after the first audio generation run. Un-exclude once
  // N1 (ElevenLabs narration) is unblocked and the first file is pushed.

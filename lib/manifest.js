...
module.exports = {
  ...
  capabilities: [
    ...
    { name: 'graph.mail.send', method: 'POST', path: '/graph/mail/send', description: 'Send mail via Microsoft Graph (sconl@acexoft.com) -- body: {to, subject, body, cc}. Plain text only, no attachments.' },

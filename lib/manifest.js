...
module.exports = {
  ...
  capabilities: [
    ...
    { name: 'google.auth.start', method: 'POST', path: '/google/auth/start', description: 'Start a Google device-code sign-in for one account label (body: {account}, defaults to \'default\'): returns a user code and verification URL.' },
    { name: 'google.auth.poll', method: 'POST', path: '/google/auth/poll', description: 'Poll whether a Google device-code sign-in has been completed yet (body: {account, deviceCode}).' },
